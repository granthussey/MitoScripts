...
assess_images();
		...
		print("Please create an imaging directory containing the PNG and TIFF files for analysis.");
		print("In this directory, PNG files should be in folders named GaussPNG/ and NoGaussPNG/ . TIFF files should be in folders named Gauss/ and NoGauss/.");
